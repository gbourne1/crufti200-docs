...
title: Quickstart
description: >-
  Learn how to install the Jamdesk CLI, edit MDX files locally, and connect
  GitHub so every push triggers an automatic docs build and deploy.
---
...
If a push conflicts, git leaves markers in the file:
...
Delete the markers, keep the text you want, then commit.
