...
- Follow the [quickstart guide](/quickstart-guide) to get set up in minutes.
- Hitting a snag? See [common build errors](/troubleshooting#build-errors).
- Rolling out to your team? Read the [SSO setup guide](/enterprise/sso-setup).
