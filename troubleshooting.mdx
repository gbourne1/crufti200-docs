...
It helps to revisit how [file organization](/writing/pages#file-organisation) maps file paths to URLs, then walk through [previewing locally with the CLI](/quickstart#1-preview-locally) one more time from the top.
